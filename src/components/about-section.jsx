...
const AboutUs = () => {
  const vid =
    "https://res.cloudinary.com/dkjx65vc7/video/upload/v1745094824/homevid_n5g9hc.mp4";
    ...
    >
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-12">
        <div className={`flex flex-col lg:flex-row items-center`}>
          ...
          >
            <div
              className={`text-[#B4E90E] text-lg md:text-2xl font-medium mb-2 ${textAlign}`}
            >
              {t("abouttitle1")}
            </div>
            ...
            <p className={`text-gray-400 mb-8 ${textAlign}`}>{t("about")}</p>

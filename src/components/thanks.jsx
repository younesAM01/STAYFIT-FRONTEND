...
const MembershipPlans = () => {
  ...
  const tt = useTranslations("ThanksPage");
  ...
  return (
    <>
      <div className="w-full bg-black/60 backdrop-blur-sm py-16 px-4 mt-5">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#B4E90E] text-black">
            <Check className="h-7 w-7" />
          </div>
          <h1 className="text-2xl md:text-4xl font-extrabold text-white mb-3" dir={locale === "ar" ? "rtl" : "ltr"}>
            {tt("title")}
          </h1>
          <p className="text-zinc-300 mb-6" dir={locale === "ar" ? "rtl" : "ltr"}>
            {tt("subtitle")}
          </p>
          <a
            href="#packs"
            className="inline-block px-6 py-3 rounded-md font-semibold border border-[#B4E90E] text-white hover:bg-[#B4E90E] hover:text-black transition-colors"
          >
            {tt("cta")}
          </a>
        </div>

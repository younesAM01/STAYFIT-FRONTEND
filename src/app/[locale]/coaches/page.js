    ...
    {t('boutton')}
      ...
      <section className="py-16 container mx-auto px-4 text-center">
        <h2 className={`text-3xl md:text-4xl font-bold mb-12`}>
          {locale === 'ar' ? 'قابل' : 'Meet'} <span className="text-[#B4E90E]">{locale === 'ar' ? 'مدربينا المحترفين' : 'Expert Coaches'}</span>
        </h2>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          ...
          {/* Repeat similar translation for other filter buttons */}
          <Button
          ...
          >
            <Heart className="h-4 w-4" /> {locale === 'ar' ? 'تمارين القلب' : 'Cardio'}
          </Button>
          <Button
          ...
          {/* Similar buttons for other categories */}
        </div>
          ...
          {filteredCoaches.map((coach) => (
            ...
            >
              ...
              <CardContent className={`py-4 px-6 ${textAlign}`}>
                ...
                <div className={`flex items-center gap-2 mb-2 ${flexDirection}`}>
